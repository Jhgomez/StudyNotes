...
FXLauncher is using this API to load a custom UI, but they are not using Java 9 modules, this means they need a way to include in the Jar file produced by fxlauncher a file with the name of the implementation following the patterns previously described in this document
